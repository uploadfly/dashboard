...
const File = ({
  ...
  return (
    <div
      className={`w-[260px] py-1 px-2 h-[280px] rounded-md bg-black/20 border-2 border-white/10 hover:border-uf-accent/50 transition-colors cursor-pointer flex flex-col justify-between items-center ${
        selected ? "border-uf-accent" : ""
      }`}
      onClick={onClick}
    >
